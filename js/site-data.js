/**
 * SPORTS DRILLS WEB - Default Content Data
 * Konten pre-filled untuk Google AdSense approval
...
const DEFAULT_CONTENT = {
  drills: [
    {
      id: "drill-basket-001",
      title: "Crossover Dribble Mastery",
      sport: "basket",
      ...
      steps: [
        "Atur 5 cones dalam garis lurus dengan jarak 1 meter",
        "Mulai dari cone pertama dengan dribble rendah menggunakan tangan kanan",
        "Lakukan crossover ke tangan kiri saat mencapai cone berikutnya",
        "Jaga head up dan eyes forward selama drill",
        "Tambahkan hesitation move sebelum crossover untuk variasi",
        "Ulangi drill 5 set dengan istirahat 30 detik antar set",
        "Tingkatkan kecepatan secara bertahap setiap set"
      ],
    ...
    },
    {
      ...
      steps: [
        "Mulai dari jarak dekat ring (free throw line)",
        "Fokus pada follow-through dengan jari telunjuk menunjuk ke ring",
        "Lakukan 10 makes berturut-turut sebelum mundur 1 langkah",
        "Ulangi proses sampai mencapai garis three-point",
        "Catat persentase tembakan dari setiap spot",
        "Lakukan 100 tembakan total per sesi",
        "Review video recording untuk koreksi form"
      ],
    ...
    },
    {
      ...
      steps: [
        "Mulai di defensive stance di ujung agility ladder",
        "Slide lateral melalui setiap rung tanpa menyilangkan kaki",
        "Tetap low dengan tangan aktif sepanjang drill",
        "Tambahkan coach cue untuk arah slide (kiri/kanan)",
        "Integrasi dengan closeout ke shooter dummy",
        "Lakukan 8 rep dengan istirahat 45 detik",
        "Tambahkan resistance band untuk intensitas ekstra"
      ],
    ...
    {
      id: "drill-futsal-001",
      title: "1v1 Dribble Attack",
      sport: "futsal",
      difficulty: "intermediate",
      duration: "20 menit",
      equipment: "Bola futsal, cones, small goals",
      image: "https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=600",
      excerpt: "Latihan 1v1 untuk melatih confidence dalam menggiring bola dan melewati defender di space terbatas.",
      description: "Futsal adalah permainan space dan waktu. Drill 1v1 ini melatih pemain untuk membuat keputusan cepat dalam situasi terbatas.",
      steps: [
        "Buat grid 10x10 meter dengan 2 small goals di ujung",
        "Attacker mulai dari tengah dengan bola",
        "Defender mulai 3 meter di depan",
        "Attacker punya 10 detik untuk mencetak gol",
        "Ganti role setelah 5 attempt",
        "Tambahkan passing option untuk variasi",
        "Lakukan scoring system untuk kompetisi"
      ],
    ...
    {
      id: "drill-futsal-002",
      title: "Passing Triangle Rush",
      sport: "futsal",
      difficulty: "beginner",
      duration: "15 menit",
      equipment: "Bola futsal, cones",
      image: "https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=600",
      excerpt: "Latihan passing segitiga dengan one-touch dan movement off the ball untuk build-up play yang fluid.",
      description: "Passing adalah jantung permainan futsal. Drill triangle melatih first touch, one-touch passing, dan movement tanpa bola secara bersamaan.",
      steps: [
        "Atur 3 cones membentuk segitiga dengan sisi 5 meter",
        "3 pemain di setiap cone, 1 pemain di tengah",
        "Pemain tengah pressing pemain dengan bola",
        "Pemain dengan bola harus one-touch pass ke pemain lain",
      "Jika bola terintercept, pemain yang salah jadi defender tengah",
        "Tambahkan requirement 2-touch maksimum",
        "Mainkan selama 3 menit per rotasi"
      ],
    ...
    {
      id: "drill-futsal-003",
      title: "Goalkeeper Reaction Saves",
      sport: "futsal",
      difficulty: "advanced",
      duration: "20 menit",
      equipment: "Bola, goal, rebounder net",
      image: "https://images.unsplash.com/photo-1560272564-c83b66b1ad12?w=600",
      excerpt: "Latihan reaksi kiper futsal dengan rebounder net untuk melatih reflex save dan positioning cepat.",
      description: "Kiper futsal harus memiliki reflex seperti kucing. Drill ini menggunakan rebounder net untuk menciptakan situasi reaksi yang tidak terduga.",
      steps: [
        "Posisikan rebounder net 3 meter di depan goal",
        "Kiper berdiri di posisi ready stance",
        "Coach atau mesin tembak bola ke rebounder",
        "Bola akan memantul ke arah random",
        "Kiper harus react dan save dalam split second",
        "Tambahkan second ball untuk scenario rebound",
        "Lakukan 50 save per sesi, catat save percentage"
      ],
    ...
    {
      id: "drill-padel-001",
      title: "Wall Volley Control",
      sport: "padel",
      difficulty: "beginner",
      duration: "15 menit",
      equipment: "Raket padel, bola",
      image: "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=600",
      excerpt: "Latihan kontrol bola dengan dinding untuk membangun feel dan touch yang dibutuhkan dalam permainan padel.",
      description: "Padel unik karena penggunaan dinding. Drill ini melatih pemain untuk memanfaatkan dinding sebagai partner latihan dan membangun touch yang lembut.",
      steps: [
        "Berdiri 2 meter dari dinding belakang",
        "Pukul bola ke dinding dengan forehand volley",
        "Biarkan bola memantul sekali sebelum volley kembali",
        "Fokus pada kontrol, bukan power",
        "Ganti ke backhand setelah 20 volley berhasil",
        "Tambahkan target zone dengan chalk/tape",
        "Challenge: 50 volley berturut-turut tanpa miss"
      ],
    ...
    },
    {
      ...
      steps: [
        "Mulai dari posisi net, partner lob ke belakang",
        "Backpedal cepat sambil tracking bola",
        "Posisikan diri di belakang bola, side-on stance",
        "Toss bola sedikit ke depan dengan non-dominant hand",
        "Contact bola di atas dan di depan kepala",
        "Aim ke feet lawan atau corner",
        "Lakukan 30 reps, fokus pada konsistensi contact point"
      ],
    ...
    {
      id: "drill-voli-001",
      title: "Serving Target Practice",
      sport: "voli",
      difficulty: "beginner",
      duration: "15 menit",
      equipment: "Bola voli, net, target zones",
      image: "https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?w=600",
      excerpt: "Latihan serve yang terarah untuk meningkatkan akurasi dan konsistensi serve pertama.",
      description: "Serve adalah satu-satunya skill dalam voli yang sepenuhnya under your control. Drill ini membangun muscle memory untuk serve yang akurat.",
      steps: [
        "Tandai 6 target zones di court lawan dengan tape",
        "Mulai dari baseline dengan 10 bola",
        "Target zone 1 (sudut kanan depan) - 5 serve",
        "Target zone 2 (sudut kiri depan) - 5 serve",
        "Target zone 3 (tengah dekat net) - 5 serve",
        "Catat berapa serve yang masuk target",
        "Tingkatkan difficulty dengan jump serve"
      ],
    ...
    },
    {
      ...
      steps: [
        "3 pemain membentuk segitiga dengan jarak 5 meter",
        "Pemain A pass ke Pemain B",
        "Pemain B set ke Pemain C",
        "Pemain C hit (spike/control) ke Pemain A",
        "Rotasi setelah 10 rallies berhasil",
        "Tambahkan requirement: semua contact harus clean",
        "Goal: 50 rallies tanpa miss"
      ],
    ...
    },
    {
      ...
      title: "Sprint Start Technique",
      sport: "atletik",
      difficulty: "beginner",
      duration: "20 menit",
      equipment: "Starting blocks, stopwatch",
      image: "https://images.unsplash.com/photo-1532444458054-01a7dd3e9fca?w=600",
      excerpt: "Latihan teknik start dari starting blocks untuk sprinter pemula yang ingin membangun fondasi yang benar.",
      description: "Start yang baik bisa membuat perbedaan 0.2-0.3 detik dalam lari 100m. Drill ini fokus pada mekanik block start yang efisien.",
      steps: [
        "Atur block dengan sudut 45-50 derajat (depan) dan 55-60 derajat (belakang)",
        "Posisikan tangan di belakang garis start, jari membentuk bridge",
        "'On your marks' - hips sedikit di atas bahu",
        "'Set' - angkat hips 2-3 inch lebih tinggi, weight di tangan",
        "'Go' - dorong ke belakang (bukan ke atas), first step powerful",
        "Drive phase: 10-15 meter dengan body angle 45 derajat",
        "Lakukan 10 starts, review video untuk koreksi"
      ],
    ...
    },
    {
      ...
      steps: [
        "Atur 5 hurdle dengan spacing 8.5 meter (standard for men)",
        "Mulai dengan walk-over drill: jalan di atas hurdle",
        "Progress ke skip drill: 1 skip antar hurdle",
        "Lakukan 3-step drill dengan 70% intensity",
        "Fokus pada lead leg action dan trail leg snap",
        "Tambahkan arm action yang exaggerated",
        "Full run 5x dengan recovery 3 menit"
      ],
    ...
    },
    {
      ...
      title: "Plyometric Box Jump Circuit",
      sport: "atletik",
      difficulty: "intermediate",
      duration: "20 menit",
      equipment: "Plyo boxes (various heights)",
      image: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=600",
      excerpt: "Circuit latihan plyometric dengan box jump untuk meningkatkan explosive power dan vertical leap.",
      description: "Plyometrics adalah metode training paling efektif untuk meningkatkan power. Circuit ini menggabungkan berbagai variasi box jump untuk stimulus maksimal.",
      steps: [
        "Warm-up: 5 menit skipping dan dynamic stretch",
        "Station 1: Standard box jump - 10 reps",
        "Station 2: Lateral box jump - 10 reps per sisi",
        "Station 3: Depth jump (drop dari 30cm, explode up) - 8 reps",
        "Station 4: Single-leg box jump - 6 reps per kaki",
        "Station 5: Box jump to broad jump - 8 reps",
        "Istirahat 2 menit antar station, 3 rounds total"
      ],
  ...
  news: [
    {
      id: "news-001",
      title: "Lakers Siap Datangkan Bintang Baru di Bursa Transfer Musim Panas",
      category: "basket",
      excerpt: "Los Angeles Lakers dilaporkan sedang dalam pembicaraan serius dengan agen beberapa free agent top untuk memperkuat roster mereka musim depan.",
      ...
      <p>LeBron James dilaporkan mendukung penuh rencana ini. Dalam podcast terbarunya, ia menyebut bahwa Lakers butuh "one more piece" untuk bisa bersaing dengan Denver Nuggets dan Oklahoma City Thunder.</p>`
    },
    {
      id: "news-002",
      title: "Timnas Futsal Indonesia Lolos ke Piala Asia 2026",
      category: "futsal",
      excerpt: "Garuda Futsal berhasil mengamankan tiket ke Piala Asia 2026 setelah kemenangan dramatis melawan Vietnam di babak playoff.",
      ...
      <p>Piala Asia Futsal 2026 akan berlangsung di Uzbekistan pada September mendatang. Indonesia tergabung di grup yang cukup berat bersama Jepang dan Iran.</p>`
    },
    {
      id: "news-003",
      title: "Fernando Alonso Pindah ke Padel? Spekulasi Menggema",
      category: "padel",
      excerpt: "Pebalap F1 Fernando Alonso tertangkap kamera sedang latihan padel intensif di Barcelona, memicu spekulasi pensiun dini dari dunia Formula 1.",
      image: "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=600",
      date: "2026-05-19",
      readTime: "3 menit",
      views: 6789,
      ...
      <p>World Padel Tour dilaporkan tertarik mengundang Alonso untuk exhibition match di Madrid Open mendatang.</p>`
    },
    {
      id: "news-004",
      title: "Red Volley Bandung Juara Proliga 2026",
      category: "voli",
      excerpt: "Setelah final dramatis melawan Jakarta Pertamina Fastron, Red Volley Bandung mengangkat trofi juara Proliga untuk pertama kalinya dalam sejarah klub.",
      image: "https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?w=600",
      date: "2026-05-18",
      readTime: "4 menit",
      views: 5678,
      ...
      <p>Kemenangan ini juga mengantarkan Red Volley ke AVC Champions League 2027.</p>`
    },
    {
      id: "news-005",
      title: "Lalu Muhammad Zohri Pecahkan Rekor Nasional 100m",
      category: "atletik",
      excerpt: "Sprinter andalan Indonesia Lalu Muhammad Zohri mencatat waktu 10.03 detik di Kejuaraan Thailand Open, memecahkan rekor nasional yang bertahan 20 tahun.",
      image: "https://images.unsplash.com/photo-1532444458054-01a7dd3e9fca?w=600",
      date: "2026-05-17",
      readTime: "3 menit",
      views: 9234,
      ...
      <p>Waktu 10.03 detik juga memenuhi standard qualifying untuk World Athletics Championships 2027 di Tokyo.</p>`
    },
    {
      id: "news-006",
      title: "Gosip: Bek Top Eropa Dikabarkan Merapat ke Liga Indonesia",
      category: "gosip",
      excerpt: "Seorang bek tengah berkewarganegaraan Argentina yang musim ini membela klub Serie A dilaporkan sedang dalam negosiasi dengan klub besar Liga 1.",
      image: "https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=600",
      date: "2026-05-21",
      readTime: "2 menit",
      views: 12456,
      ...
      <p>Nama pemain masih dirahasiakan, tapi rumor menyebut klub yang tertarik adalah juara bertahan Liga 1.</p>`
    },
    {
      id: "news-007",
      ...
      <p>San Antonio Spurs yang memegang first overall pick dilaporkan sangat tertarik, meskipun mereka sudah punya Victor Wembanyama.</p>`
    },
    {
      id: "news-008",
      ...
      <p>Turnamen Master Final akan kembali dihelat di Madrid pada Desember 2026 dengan prize pool 2 juta euro.</p>`
    },
    {
      id: "news-009",
      ...
      <p>FIVB belum memberikan komentar resmi, tapi rumor menyebut mereka sedang mempertimbangkan regulasi baru terkait spin serve.</p>`
    },
    {
      id: "news-010",
      title: "Futsal Indonesia Bakal Punya Liga Profesional Tahun Depan",
      category: "futsal",
      excerpt: "PSSI dan PT LIB mengumumkan pembentukan Liga Futsal Profesional Indonesia yang akan dimulai pada musim 2026/2027.",
      image: "https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=600",
      date: "2026-05-13",
      readTime: "4 menit",
      views: 7890,
      ...
      <p>Total prize pool untuk musim perdana diperkirakan mencapai 50 miliar rupiah, dengan juara mendapatkan 15 miliar rupiah.</p>`
    },
    {
      id: "news-011",
      ...
      <p>Persaingan di Asian Games memang ketat, terutama dari Jepang, Tiongkok, dan India. Tapi PB PASI yakin dengan persiapan yang matang, target bisa tercapai.</p>`
    },
    {
      id: "news-012",
      ...
      <p>Satria Muda dilaporkan sedang mencari pengganti Ford, dengan beberapa nama import dari Amerika Serikat sedang dalam proses scouting.</p>`
    }
  ],
...
function saveContent(content) {
  try {
    localStorage.setItem('sportsDrillsContent', JSON.stringify(content));
    return true;
  } catch (e) {
...
// Get latest news
function getLatestNews(count = 6) {
  const content = loadContent();
  return content.news
...
function getNewsByCategory(category) {
  const content = loadContent();
  return content.news.filter(n => n.category === category);
}

// Get drills by sport
function getDrillsBySport(sport) {
  const content = loadContent();
  return content.drills.filter(d => d.sport === sport);
}

// Get coach by ID
function getCoach(id) {
  const content = loadContent();
  return content.coaches.find(c => c.id === id);
}

// Get all coaches
function getAllCoaches() {
  return loadContent().coaches;
}
